 ...
 */
export async function reconcileStalePaymentAttempts(
  staleMinutes = 15,
  ...
  if (
    ...
    throw new Error(
      "staleMinutes must be a positive number",
    );
  }
    ...
    for (const attempt of attemptsResult.rows) {
      ...
      if (attempt.order_status === "paid") {
        ...
        await client.query(
          ...
          [
            ...
            JSON.stringify({
              ...
              reason:
                "Order was already paid by another successful attempt.",
            }),
          ],
        );
        ...
        result.results.push({
          ...
          action: "marked_failed",
          reason:
            "Payment order was already paid by another successful attempt.",
        });
      ...
      if (!attempt.provider_reference) {
        await client.query(
          ...
          [
            ...
            JSON.stringify({
              ...
              action: "skipped",
              reason:
                "No provider reference is available.",
            }),
          ],
        );
        ...
        result.results.push({
          ...
          action: "skipped",
          reason:
            "No provider reference is available for provider reconciliation.",
        });
      ...
      if (providerResult.status === "success") {
        ...
        if (
          (updatedAttemptResult.rowCount ?? 0) ===
          0
        ) {
          continue;
        }
          ...
          await client.query(
            ...
            [
              ...
              JSON.stringify({
                ...
                reason:
                  "Provider confirmed success, but the order was already paid.",
              }),
            ],
          );
          ...
          [
            ...
            JSON.stringify({
              ...
              failureCode:
                ...
                "PROVIDER_PAYMENT_FAILED",
              reason:
                "Provider confirmed that the payment failed.",
            }),
          ],
        );
      ...
      await client.query(
        ...
        [
          ...
          JSON.stringify({
            ...
            action: "skipped",
            reason:
              "Provider could not determine the final payment status.",
          }),
        ],
      );
