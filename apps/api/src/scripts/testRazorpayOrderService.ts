...
import {
  createRayFlowRazorpayOrder,
} from "../services/razorpayOrderService.js";

async function main(): Promise<void> {
  console.log(
    "Creating Razorpay order through RayFlow Order Service...",
  );
...
main().catch((error: unknown) => {
  console.error("");
  console.error(
    "RayFlow Razorpay Order Service test failed.",
  );
